          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <section aria-labelledby="filter-heading" className=" pt-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="inline-block text-sm font-medium text-gray-700 hover:text-rose-500 sm:hidden"
                ...
                <Popover.Group className="hidden sm:flex sm:items-baseline sm:space-x-8">
                  {filters.map((section, sectionIdx) => (
                    <Popover as="div" key={section.name} id="menu" className="relative z-10 inline-block text-left">
                      <div>
                        <Popover.Button className="group inline-flex items-center justify-center text-sm font-medium text-gray-700 hover:text-rose-600">
                            ...
                            {section.options.map((option, optionIdx) => (
                              <div key={option.value} className="flex items-center">
                                ...
                                <label
                                  ...
                                  className="ml-3 pr-6 text-sm font-medium text-rose-600 whitespace-nowrap"
                                >
                                  {option.label}
                                </label>
                              </div>
              ...
              <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:gap-x-8">
                {products1.map((product) => (
                  <a key={product.id} href={product.href} className="group">
                    ...
                    <div className="mt-4 flex items-center justify-between text-base font-medium text-rose-600">
                      <h3>{product.name}</h3>
                      <h5>{product.price}</h5>
                    </div>
                    <h5 className="mt-1 text-sm italic text-gray-500">{product.description}</h5>
                  </a>
                ))}
              </div>
            </section>
            ...
            <section aria-labelledby="featured-heading" className="relative mt-16 rounded-lg overflow-hidden lg:h-96">
              ...
              <div className="absolute inset-x-0 bottom-0 bg-black bg-opacity-75 p-6 rounded-bl-lg rounded-br-lg backdrop-filter backdrop-blur sm:flex sm:items-center sm:justify-between lg:inset-y-0 lg:inset-x-auto lg:w-96 lg:rounded-tl-lg lg:rounded-br-none lg:flex-col lg:items-start">
                <div>
                  ...
                  <h5 className="mt-1 text-sm text-gray-300">
